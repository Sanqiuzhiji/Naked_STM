...
#define	LCD_LED(x) HAL_GPIO_WritePin(TFT_LED_GPIO_Port,TFT_LED_Pin, x) //LCD背光    		 PB9
...
#define	LCD_RST_CLR	HAL_GPIO_WritePin(TFT_Reset_GPIO_Port,TFT_Reset_Pin,GPIO_PIN_RESET)    //复位			  PB12
